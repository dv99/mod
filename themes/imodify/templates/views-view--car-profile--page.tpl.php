...
<div style="padding: 20px 0 20px 40px; width: 494px; float: left;"><img src="<?php echo base_path() . path_to_theme();?>/images/stream-lock.jpg" /></div>
 ...
 <div style="margin:15px 0;"><div class="postTabs">
        ...
        <div class="feeds">
        	<div class="left"><img src="<?php echo base_path() . path_to_theme();?>/images/car_small.gif" width="50" height="50" alt="" /></div>
            <div class="right">
