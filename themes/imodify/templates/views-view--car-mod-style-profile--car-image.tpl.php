	...
	<div class="updatecar_box5" style="margin-bottom:0px;">
        <div class="carmake_bottombox_head1">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="22%">RESTYLING MARKET</td>
...
<div id="image_car" style="height: 158px;">
<div class="carmake_main">
      ...
      <ul>
      	<?php $i=1; $j=count($view->result);
			...
			foreach($view->result as $value){
				...
				$imgVars = array();
				$imgVars['item']=array('uri'=>$imgPath,'alt'=>'','width'=>95,'height'=>67,'title'=>'','attributes'=>array('class'=>'','onError'=>'this.src="'.path_to_theme().'/images/img_not.png"'));
				$imgVars['image_style']='';
...
<a href="#"><img src="<?php echo base_path() . path_to_theme();?>/images/bt26.png" width="97" height="18" /></a>
</div>
</div>