...
//alert(val);
	...
	$("#cat").html('<table width="60" cellpadding="0" cellspacing="0"><tr><td height="45" align="center" valign="middle">'+imgLoading+'</td></tr></table>');
...
$("#load_article").html('<div style="padding-left:200px; padding-top:200px;"><img src="/sites/default/files/ajax-loader1.gif" width="50" height="20"/></div>');
...
$("#make_image").html('<div style="padding-left:70px; margin-top:-25px"><img src="/sites/default/files/ajax-loader1.gif"/></div>');

$("#mod_image").html('<div style="padding-left:70px; margin-top:-25px"><img src="/sites/default/files/ajax-loader1.gif"/></div>');
