...
<?php
	...
	$imgUri=$value[0]->field_field_event_image[0]['raw']['uri'];
...
<div style="width:542px; margin-top:10px;">
	...
	<div id="top_bar" style="float:left;">
		<a href="<?php echo base_path().'events';?>" style="color:#F8A74A;">Back to main Page</a>
		<a class="addthis_button" id="addthis_button_top" href="http://www.addthis.com/bookmark.php?v=250&amp;pubid=ra-4ff6c82229926a13" addthis:url="<?php echo $site_path.'events/'.$value[0]->nid;?>"
