...
$("#cat select option:first-child").attr("selected", true);
 ...
 function clic(){
  val1=$('#edit-jump1').val();
	val2=$('#edit-jump3').val();
	val3=$('#edit-jump2').val();
	val4=<?php echo $view->result[0]->nid;?>;
			
	$("#block-views-garage-garage-gallery").html('<div style="padding-left:200px; padding-top:200px; "><img src="/sites/default/files/ajax-loader1.gif" width="50" height="20"/></div>');
  ...
  //viewArgument =  val;
   ...
   $.ajax({
    ...
    url: Drupal.settings.basePath + 'views/ajax',
    dataType: 'json',
    data: 'view_name=' + viewName + '&view_display_id=garage_gallery&view_args=' + val4 + '/'+ val2 + '/'+ val3, // Pass a key/value pair.
    success: function(data) {
      viewHtml = data[1].data;
      $("#block-views-garage-garage-gallery").html(viewHtml);
    }
  });
 }
